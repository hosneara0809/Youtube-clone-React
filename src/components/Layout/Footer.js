                        ...
                        <div className="row">
                            <div className="col-xl-7">
                                <ul className="nav footer-menu justify-content-center justify-content-xl-start">
                                    ...
                                    <li className="nav-item">
                                        <Link to="/terms" className="nav-link text-dark py-0 ps-0">Terms and Conditions</Link>
                                    </li>

                                    <li className="nav-item">
                                        <Link to="/privacy" className="nav-link text-dark py-0 ps-0">Privacy and Policy</Link>
                                    </li>

                                    <li className="nav-item">
                                        <Link to="/contact" className="nav-link text-dark py-0 ps-0">Contact</Link>
                                    </li>
                                </ul>
                            </div>
